...
incluirTemplate('header', $inicio = true ); //LLAMAMAOS A LA FUNCION CON EL NOMBRE DEL ARCHIVO DE LA CARPETA TEMPLATE
...
<div class="contenedor seccion seccion-inferior">
    <section class="blog"> <!--A section lo usamos cuando luego viene un headign-->
        <h3>Nuestro Blog</h3>

        <article class="entrada-blog"> <!--Cuando realizamos un blog o entrada de blog se usa article-->
            <div class="imgaen">
                <picture>
            ...
            <div class="texto-entrada">
                <a href="entrada.html">
                    ...
                    <p class="informacion-meta">Escrito el: <span>20/12/22</span> por: <span>Admin</span></p>
